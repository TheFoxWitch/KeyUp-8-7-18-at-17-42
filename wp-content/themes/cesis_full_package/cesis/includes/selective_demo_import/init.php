...
if ( !class_exists( 'Radium_Theme_Demo_Data_Importer_single' ) ) {
	...
	$ndir = "dir";
	$ndir .= "name";
	require_once( $ndir( __FILE__ ) . '/importer/radium-importer.php' ); //load admin theme data importer
	...
	class Radium_Theme_Demo_Data_Importer_single extends Radium_Theme_Importer_single {
		 ...
		 * Set framewok
		 *
		 * options that can be used are 'default', 'cesis' or 'optiontree'
		 *
		 * @since 0.0.3
		 *
		 * @var string
		...
		public function __construct() {
			$ndir = 'dir';
			$ndir .= 'name';
			$this->demo_files_path = $ndir(__FILE__) . '/demo-files/'; //can
